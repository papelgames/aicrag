...
class EgresosForm(FlaskForm):
    ...
    modalidad_pago =SelectField('Modalidad de pago', choices =[( '','Seleccionar modalidad de pago'),('eft','Efectivo'),('qr','QR'),('tarj','Tarjeta'),('transf','Transferencia bancaria')], coerce = str, default = None, validators=[DataRequired('Debe seleccionar una modalidad de pago')])
